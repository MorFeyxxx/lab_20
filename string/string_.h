...
// возвращает значение 0, если слово не было считано, иначе возвращено значение 1 и в переменную word типа
// WordDescriptor будут записаны позиции начала слова, и первого символа после конца слова.
...
// возвращает значение 0, если слово не было считано, иначе возвращено значение 1 и в переменную word типа
// WordDescriptor будут записаны позиции начала и конец слова.
