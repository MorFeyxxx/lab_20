#ifndef UNTITLED1_GET_WORDS_OTHER_THAN_LAST_WORD_H
#define UNTITLED1_GET_WORDS_OTHER_THAN_LAST_WORD_H
...
void test_15_last_unique() {
    ...
    get_word_except_last(source, dest);
    ASSERT_STRING("hello", dest);
}

void test_15_last_not_unique() {
    char source[] = "bim bam is bam";
    char dest[40] = "";

    get_word_except_last(source, dest);
    ASSERT_STRING("bim is", dest);
}

void test_15_get_words_other_then_last_word() {
    test_15_empty();
    test_15_one_word();
    test_15_last_unique();
...
#endif //UNTITLED1_GET_WORDS_OTHER_THAN_LAST_WORD_H
