#ifndef UNTITLED1_REARRANGE_NUMBERS_H
#define UNTITLED1_REARRANGE_NUMBERS_H
...
void test_rearrange_numbers_1_empty_file() {
    const char filename[] = "F:\\laba_op_19\\task_7\\test_1.txt";
...
void test_rearrange_numbers_2_only_negative_numbers() {
    const char filename[] = "F:\\laba_op_19\\task_7\\test_2.txt";
...
void test_rearrange_numbers_3_only_positive_numbers() {
    const char filename[] = "F:\\laba_op_19\\task_7\\test_3.txt";
...
void test_rearrange_numbers_4_mixed_numbers() {
    const char filename[] = "F:\\laba_op_19\\task_7\\test_4.txt";
...
#endif //UNTITLED1_REARRANGE_NUMBERS_H
