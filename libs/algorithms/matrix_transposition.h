#ifndef UNTITLED1_MATRIX_TRANSPOSITION_H
#define UNTITLED1_MATRIX_TRANSPOSITION_H
...
void test_matrix_transpose_1_one_element_matrix() {
    const char filename[] = "F:\\laba_op_19\\task_1\\test_1.txt";
...
void test_matrix_transpose_2_unit_symmetric_matrix() {
    const char filename[] = "F:\\laba_op_19\\task_1\\test_2.txt";
    int n = 3;
...
void test_matrix_transpose_3_matrix() {
    const char filename[] = "F:\\laba_op_19\\task_1\\test_3.txt";
    int n = 3;
...
#endif //UNTITLED1_MATRIX_TRANSPOSITION_H
