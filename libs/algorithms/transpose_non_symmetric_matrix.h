#ifndef UNTITLED1_TRANSPOSE_NON_SYMMETRIC_MATRIX_H
#define UNTITLED1_TRANSPOSE_NON_SYMMETRIC_MATRIX_H
...
void test_transpose_non_symmetric_matrix_1_empty_matrix() {
    const char filename[] = "F:\\laba_op_19\\task_8\\test_1.txt";
...
void test_transpose_non_symmetric_matrix_2_one_matrices() {
    const char filename[] = "F:\\laba_op_19\\task_8\\test_2.txt";
...
void test_transpose_non_symmetric_matrix_3_symmetric_matrix() {
    const char filename[] = "F:\\laba_op_19\\task_8\\test_3.txt";
...
void test_transpose_non_symmetric_matrix_4_non_symmetric_matrix() {
    const char filename[] = "F:\\laba_op_19\\task_8\\test_4.txt";
...
void test_transpose_non_symmetric_matrix_5_mixed_matrix() {
    const char filename[] = "F:\\laba_op_19\\task_8\\test_5.txt";
...
#endif //UNTITLED1_TRANSPOSE_NON_SYMMETRIC_MATRIX_H
