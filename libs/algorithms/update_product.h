#ifndef UNTITLED1_UPDATE_PRODUCT_H
#define UNTITLED1_UPDATE_PRODUCT_H
...
void test_update_product_1_empty_files() {
    const char filename1[] = "F:\\laba_op_19\\task_10\\test_1_1.txt";
    const char filename2[] = "F:\\laba_op_19\\task_10\\test_1_2.txt";
...
void test_update_product_2_first_file_empty() {
    const char filename1[] = "F:\\laba_op_19\\task_10\\test_2_1.txt";
    const char filename2[] = "F:\\laba_op_19\\task_10\\test_2_2.txt";
...
void test_update_product_3_second_file_empty() {
    const char filename1[] = "F:\\laba_op_19\\task_10\\test_3_1.txt";
    const char filename2[] = "F:\\laba_op_19\\task_10\\test_3_2.txt";
...
void test_update_product_4_order_more_product() {
    const char filename1[] = "F:\\laba_op_19\\task_10\\test_4_1.txt";
    const char filename2[] = "F:\\laba_op_19\\task_10\\test_4_2.txt";

    product pr1 = {.product_name="name1", .unit_price=10, .total_cost=70, .quantity=7};
    product pr2 = {.product_name="name2", .unit_price=20, .total_cost=80, .quantity=4};
...
void test_update_product_5_order_less_product() {
    const char filename1[] = "F:\\laba_op_19\\task_10\\test_5_1.txt";
    const char filename2[] = "F:\\laba_op_19\\task_10\\test_5_2.txt";

    product pr1 = {.product_name="name1", .unit_price=10, .total_cost=40, .quantity=4};
    product pr2 = {.product_name="name2", .unit_price=20, .total_cost=200, .quantity=10};
    order od = {.order_name="name2", .quantity=8};
...
#endif //UNTITLED1_UPDATE_PRODUCT_H